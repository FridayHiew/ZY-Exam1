// sampleCollections.ts - 簡化版，適合小學生
...
export const SAMPLE_COLLECTIONS: KnowledgeCollection[] = [
  ...
  // ============================================================
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['我今天很开心。', '我今天开心很。', '开心我今天很。', '我很今天开心。'],
        correctIndex: 0,
    ...
    questions: [
      {
        ...
        options: ['太阳在西方落下', '太阳早上从东方出来', '太阳晚上出来', '太阳不会出来'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['坐在树下等兔子来撞', '不努力也能成功', '要勤劳，不能懒惰等待', '兔子很笨'],
        correctIndex: 2,
      ...
      },
      {
        ...
        options: ['给蛇画脚，多此一举', '画蛇画得很好', '蛇有很多脚', '画画比赛赢了'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: ['直接写结尾', '写一个吸引人的开头', '什么也不写', '随便写'],
        correctIndex: 1,
        explanation: '作文开头要吸引人，比如 "今天是个特别的日子..." 这样读者就想往下看啦！',
      ...
      },
      {
        ...
        options: ['猫喜欢吃鱼', '做事要专心，不能三心二意', '钓鱼很容易', '猫很懒惰'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['不写结尾', '写一个总结和感受', '随便写', '重复开头'],
        correctIndex: 1,
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['东西的大小', '数量的多少', '颜色的美丑', '声音的高低'],
        correctIndex: 1,
  ...
  // ============================================================
  {
    ...
    group: '英文',
    difficulty: 'Standard 1',
    tags: ['english', 'alphabet', 'colors', 'animals'],
    version: 1,
    ...
    questions: [
      {
        ...
        options: ['I like apples.', 'I apples like.', 'Like I apples.', 'Apples I like.'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: ['太阳从西方升起', '太阳从东方升起', '太阳在南方', '太阳不升起'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Dear ___', 'Hi ___', 'Hello ___', '以上都可以'],
        correctIndex: 3,
        explanation: '写信开头可以用 Dear, Hi 或 Hello，都是礼貌的表达！',
      ...
      },
      {
        ...
        options: ['练习使人完美', '完美不需要练习', '练习很无聊', '完美很容易'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: ['Dear Diary', 'Today I...', 'Yesterday...', '以上都可以'],
        correctIndex: 3,
  ...
  // ============================================================
  {
    ...
    group: '马来文',
    difficulty: 'Standard 2',
    tags: ['kosa-kata', 'ejaan', 'ayat-mudah'],
    version: 1,
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['我喜欢吃饭', '我喜欢吃面', '我喜欢吃面包', '我不喜欢吃饭'],
        correctIndex: 0,
  ...
  },
  {
    ...
    group: '马来文',
    difficulty: 'Standard 5',
    tags: ['bahasa-melayu', 'tatabahasa', 'pemahaman'],
    version: 1,
    ...
    questions: [
      {
        ...
        options: ['Saya makan nasi.', 'Saya nasi makan.', 'Makan saya nasi.', 'Nasi saya makan.'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: ['地球是方的', '地球是圆的', '地球是三角形', '地球是平的'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['准备应对未来', '不要准备', '等下雨才准备', '雨伞没用'],
        correctIndex: 0,
      ...
      },
      {
        ...
        options: ['Pada suatu hari...', 'Tadi...', 'Semalam...', '以上都可以'],
        correctIndex: 3,
        explanation: '马来文作文开头可以用 "Pada suatu hari..." (有一天), "Tadi..." (刚才) 或 "Semalam..." (昨天)。',
      ...
      },
      {
        ...
        options: ['懒惰学习', '勤劳学习，喜欢提问', '不喜欢问问题', '学习没用'],
        correctIndex: 1,
      ...
      },
      {
        ...
        options: ['Sekian, terima kasih.', 'Yang benar,', 'Itulah ceritaku hari ini.', '以上都可以'],
        correctIndex: 3,
